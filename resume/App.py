...
connection = pymysql.connect(host='localhost' ,user='root' ,password='0607' ,db='cv')
...
st.set_page_config(
    page_title="Skillsync Analytics",
...
def run():
    ...
    link = '[©Developed by Skillsync Services](https://www.linkedin.com/in/mrbriit/)'
